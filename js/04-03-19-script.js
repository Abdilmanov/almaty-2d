require([
  ...
  PictureMarkerSymbol, SpatialReference, QueryTask, Query, LayerList, ScaleBar, IdentifyTask, IdentifyParameters,
  FeatureLayer, Locate, Home, Fullscreen, urlUtils, Directions, BasemapGallery, Search, CoordinateConversion,
  GraphicsLayer, TileLayer, Basemap, DistanceMeasurement2D, AreaMeasurement2D, MapView, WebMap, Map, esriConfig
){

  var identifyTask, identifyParams, tileLayer, myBasemap, map, view, ccWidget, searchWidget, basemapGallery,
    fullscreen, locateBtn, home, basemaps, map1, featureLayer, resultsLayer, start_day, end_day;
  ...
  document.getElementById("change_data_button").addEventListener("click",
    function(){
  ...
  var dayCount = 2;
  var periodCount = "th_w_m_h_y";
  var periods_active = false;
  ...
  function doQuery(){
    ...
    var where="CITY_CODE = 1975 AND DAT_SOVER>= TIMESTAMP '"+getDate("start")+"'"+
    ...
    // document.getElementById("main_loading").style.display = "none";
    // document.getElementById("main_loading").style.opacity = 1;
  };
  ...
  //   switch (value) {
  //     case "threeDay" :
  //       var yearStart = nowDate.getFullYear();
  //       var yearEnd = nowDate.getFullYear();
  ...
  //         day = "0" + day;
  //       };
  //       startDay = yearStart + "-" + month +"-"+ day +" 00:00:00";
  //       endDay = yearEnd + "-" + month +"-"+ nowDate.getDate() +" 23:59:59";
  //       break;
  //     case "week" :
  ...
  //       endDay = year + "-" + month +"-"+ nowDate.getDate()+" 23:59:59";
  //       break;
  //     case "month" :
  //       var year = nowDate.getFullYear();
  //       var month = nowDate.getMonth()+1;
  ...
  //       break;
  //     case "half_year" :
  //       var yearStart = nowDate.getFullYear()-1;
  //       var yearEnd = nowDate.getFullYear();
  //       var month = nowDate.getMonth()+1;
  //       var new Date(theDate.getTime() - 182*24*60*60*1000)
  //       if(month < 10){
  //         month = "0" + month;
  //       };
  //       var day = nowDate.getDate();
  ...
  //       };
  //       startDay = yearStart + "-" + month +"-"+ day +" 00:00:00";
  //       endDay = yearEnd + "-" + month +"-"+ day +" 23:59:59";
  //       break;
  //     case "year" :
  //       var yearStart = nowDate.getFullYear()-1;
  //       var yearEnd = nowDate.getFullYear();
  ...
  //   // originates from
  //   ident(if)yTask.execute(params).then(function(response) {
  //
